...
function usage() {
	return [
		'Usage: pnpm --dir producer/swift-browser run workflow:preflight -- --bootstrap-source <true|false> --source-root <dir> --build-dir <dir> --browser-build-command <command> --swift-version <version> --wasm-sdk-id <sdk_id>',
		'',
