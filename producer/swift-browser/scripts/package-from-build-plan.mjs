...
function usage() {
	return [
		'Usage: pnpm --dir producer/swift-browser run package:from-plan -- --plan <build-plan.json> --swift-version <version> --wasm-sdk-id <sdk_id> --source <provenance>',
		'',
		'Verifies browser compiler outputs recorded by build:browser-compiler, prepares raw-runtime,',
		'and packages producer/swift-browser/dist with build-plan provenance.',
