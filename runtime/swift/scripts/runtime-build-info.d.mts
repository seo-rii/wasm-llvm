...
export function createSwiftRuntimeBuildInfo({ swiftVersion, wasmSdkId, wasmSdkUrl, wasmSdkChecksum, source, notes }: {
    swiftVersion: any;
    wasmSdkId: any;
    wasmSdkUrl: any;
    wasmSdkChecksum: any;
...
export function validateSwiftRuntimeSdkChecksum(buildInfo: any, { bundleDir, messagePrefix }?: {
    bundleDir?: any;
