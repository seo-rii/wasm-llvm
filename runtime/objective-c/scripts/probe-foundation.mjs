...
import App from '@seo-rii/wasm-llvm/runtime/clang/internal/app';
import { MemFS } from '@seo-rii/wasm-llvm/runtime/clang/internal/memory/index';
import { compile } from '@seo-rii/wasm-llvm/runtime/clang/internal/wasm';
...
const STATIC_DIR = path.join(REPO_ROOT, 'dist', 'runtime', 'objective-c', 'assets');
const CLANG_BASE_URL = pathToFileURL(
	path.join(REPO_ROOT, 'dist', 'runtime', 'clang', 'assets') + path.sep
);
